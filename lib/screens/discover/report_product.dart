...
import '../../view_models/discover/report_product.vm.dart';
...
class ReportProduct extends StatelessWidget {
  const ReportProduct({Key? key, required this.productId}) : super(key: key);
  final String productId;

  @override
  Widget build(BuildContext context) {
    return MVVM(
      view: (_, __) => _ReportProductView(),
      viewModel: ReportProductViewModel(productId: productId),
    );
  }
}

class _ReportProductView extends HookView<ReportProductViewModel>
    with HookScreenLoader {
  @override
  Widget screen(BuildContext context, ReportProductViewModel viewModel) {
          ...
          child: KeyboardActions(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Let us know why this product needs to be reported.',
                  style: Theme.of(context)
                      .textTheme
                      .headline6
                      ?.copyWith(color: Colors.black),
