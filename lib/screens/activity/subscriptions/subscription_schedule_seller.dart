...
class SubscriptionScheduleSeller extends StatelessWidget {
  const SubscriptionScheduleSeller({Key? key, required this.subscriptionPlan})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MVVM(
      view: (_, __) => _SellerSubscriptionScheduleView(),
...
class _SellerSubscriptionScheduleView
