...
import '../../../view_models/profile/shop/report_shop.vm.dart';
...
class ReportShop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MVVM(
      view: (_, __) => _ReportShopView(),
      viewModel: ReportShopViewModel(shopId: shopId),
    );
  }
}

class _ReportShopView extends HookView<ReportShopViewModel>
    with HookScreenLoader {
  @override
  Widget screen(BuildContext context, ReportShopViewModel viewModel) {
          ...
          child: KeyboardActions(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Let us know why this shop needs to be reported.',
                  style: Theme.of(context)
                      .textTheme
                      .headline6
                      ?.copyWith(color: Colors.black),
