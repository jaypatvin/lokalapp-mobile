...
class ActivityFeedService {
  ...
  Future<http.Response> getAll({required String idToken}) async {
    return await http.get(
      Uri.parse("$activitiesUrl/activities"),
      headers: {"Authorization": "Bearer $idToken"},
    );
  }
  ...
  Future<http.Response> getUserActivities(
    ...
    return await http.get(
      Uri.parse("$usersUrl/$userId/activities"),
      headers: {"Authorization": "Bearer $idToken"},
    );
  }
  ...
  Future<http.Response> getCommunityActivities(
    ...
    return await http.get(
      Uri.parse("$communityUrl/$communityId/activities"),
      headers: {"Authorization": "Bearer $idToken"},
    );
  }
...
// --POST
  ...
  Future<http.Response> like({
    ...
    var response = await http.post(
      Uri.parse("$activitiesUrl/$activityId/like"),
      headers: {
        "Content-Type": "application/json",
        "Authorization": "Bearer $idToken"
      },
