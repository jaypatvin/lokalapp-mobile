...
class CommentsService {
  ...
  Future<http.Response> getById(
    ...
    return await http.get(
      Uri.parse("$activitiesUrl/$activityId/comments/$commentId"),
  ...
  Future<http.Response> getActivityComments(
    ...
    return await http.get(
      Uri.parse("$activitiesUrl/$activityId/comments"),
      headers: {"Authorization": "Bearer $idToken"},
    );
  }
  ...
  Future<http.Response> getUserComments(
    ...
    return await http.get(
      Uri.parse("$usersUrl/$userId/comments"),
      headers: {"Authorization": "Bearer $idToken"},
    );
  }
...
// --POST
  ...
  Future<http.Response> like({
    ...
    var response = await http.post(
      Uri.parse("$activitiesUrl/$activityId/comments/$commentId/like"),
      headers: {
        "Content-Type": "application/json",
        "Authorization": "Bearer $idToken"
      },
...
// --PUT
  Future<http.Response> update(
    ...
    return await http.put(
      Uri.parse("$activitiesUrl/$activityId"),
      headers: {
        "Content-Type": "application/json",
        "Authorization": "Bearer $idToken"
      },
